...
function Navbar() {
  ...
  return (
    <motion.div
      ...
      className="fixed z-[999] w-full px-14 py-5 flex justify-between items-center backdrop-blur-sm mix-blend-difference"
    >
      <div className="logo">
        <svg
          width="72"
      ...
      <div className='links flex gap-10 font-["Neue_Montreal"] font-extralight'>
        {["Services", "Our Work", "About Us", "Insights", "Contact Us"].map(
          (item, index) => (
            <a
              href="#"
              key={index}
              className={`text-[1.1vw] font-["Neue_Montreal"] font-extralight ${
                index === 4 && "ml-60"
              }`}
            >
              {item}
